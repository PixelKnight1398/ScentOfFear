...
enum Slot { HEAD, CHEST, LEGS, BACKPACK, RIGHT_HAND, LEFT_HAND, FEET }
...
func equip_item(item: EquipmentDataType, slot: Slot) -> void:
...
func unequip_item(slot: Slot) -> EquipmentDataType:
